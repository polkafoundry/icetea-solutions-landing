...
const OurSuccessTop = () => {
  return (
    <div>
      <div className="gamefi_market_bg h-[456px] mt-[50px]">
        <div className="w-full max-w-[500px] px-[40px] pt-[60px] bg-[#050512] h-full">
          ...
          <p className="text-[40px] leading-[50px] text-white mt-3">
          ...
          <p className="flex text-[#61FF8D] text-[16px] gap-[8px] mt-5">
            <FaCheckCircle
              fontSize={"16px"}
              color={"#61FF8D"}
              className="mt-[4px]"
          ...
          <button className="flex flex-nowrap gap-[8px] text-white border-white border-[1px] px-[30px] py-[10px] rounded-[40px] mt-[20px] font-[600] items-center">
            Live website
      ...
      <div className="flex gap-[20px] mt-5">
        <div className="grid px-7 pt-[30px] bg-[#050512] w-full max-w-[387px]">
          <div className="mb-[20px]">
            <p className="text-[14px] text-[#FF8142] uppercase font-bold">
              BLOCKCHAIN DEVELOPMENT
            </p>
            <p className="text-[32px] leading-[40px] text-white mt-1">Firebird Chain</p>
        ...
        <div className="grid px-7 pt-[30px] bg-[#050512] w-full max-w-[387px]">
          <div className="mb-[20px]">
            ...
            <p className="text-[32px] leading-[40px] text-white mt-1">PolkaSafe Wallet </p>
            <p className="text-[14px] text-white mt-1 opacity-[0.7]">
        ...
        <div className="grid px-7 pt-[30px] bg-[#050512] w-full max-w-[387px]">
          <div className="mb-[20px]">
            ...
            <p className="text-[32px] leading-[40px] text-white mt-1">Metaforce.org</p>
            <p className="text-[14px] text-white mt-1 opacity-[0.7]">
              This blockchain mobile wallet was designed to support
              Polkadot&apos;s Auction Development, promising a simple,
              intuitive, and easy-to-navigate user experience.
