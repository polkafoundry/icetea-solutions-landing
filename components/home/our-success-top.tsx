  ...
  return (
    <div>
      <div className="gamefi_market_bg md:h-[456px] mt-[50px]">
        <div className="w-full md:max-w-[500px] px-5 md:px-[40px] pt-[30px] md:pt-[60px] bg-[#050512] h-full">
          <p className="text-[14px] text-[#61FF8D] uppercase font-bold">
            MARKETPLACE DEVELOPMENT
          </p>
          <p className="hidden md:block text-[40px] leading-[50px] text-white mt-3">
      ...
      <div className="md:flex gap-[20px] mt-5">
        <div className="grid px-7 pt-[30px] mt-5 md:mt-0 bg-[#050512] w-full md:max-w-[387px]">
