...
const OfficeLocation = () => {
  return (
    <div>
      ...
      <div className="max-w-[1440px] px-5 mx-auto grid grid-cols-2 gap-[72px] mt-10">
        <div className="p-6 border border-[#0083FF] rounded-[26px] text-[#0030C0]">
          <Image
            src="/images/home/location_preview.png"
            className="w-full h-[390px] rounded-[2px]"
            width={947}
            height={588}
            priority
            loading="eager"
            alt="location"
          />
          <div className="text-[24px] leading-[30px] font-semibold flex mt-[35px] gap-1">
            <LocationIcon />
            Ha Noi - Viet Nam
          </div>
          <ul className="text-[17px] leading-[26px] list-disc pl-5 mt-1">
