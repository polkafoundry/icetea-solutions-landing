...
const ContractType = () => {
  return (
    <div>
      ...
      <div className="max-w-[1440px] px-5 mx-auto grid grid-cols-2 gap-12 mt-[75px]">
          ...
          (offeringContractType: any, index: number) => {
            return (
              ...
              >
                <div
                  className={clsx(
                    "absolute w-[404px] top-[-26px] left-1/2 -translate-x-1/2 py-3 text-[24px] leading-[30px] font-semibold",
