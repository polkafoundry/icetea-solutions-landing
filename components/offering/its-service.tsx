...
export const ITSServices = () => {
  return (
    <div>
      <div className="max-w-[1440px] px-5 mt-[60px] mx-auto grid grid-cols-4 gap-x-6 gap-y-[72px]">
          ...
          return (
            <div key={index} className="relative h-full group">
              <div className="px-4 h-full pt-5 pb-10 border border-[#0083FF] rounded-[24px] text-[#0030C0]">
                ...
                <div className="mt-3 text-[24px] leading-[30px] font-semibold text-center">
                  {service?.title}
                </div>
