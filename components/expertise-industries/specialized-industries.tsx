...
const SpecializedIndustries = () => {
  return (
    <>
      <div className="mt-12 text-[48px] leading-[70px] font-semibold text-[#0030C0] text-center">
        Specialized Industries
      </div>
      <div className="pt-12 grid grid-cols-4 gap-5 max-w-[1440px] px-5 mx-auto">
        <div className="flex hover:block cursor-pointer group items-center justify-center h-[334px] border border-[#0083FF] rounded-[24px]">
          <div className="px-6">
            <Image
              ...
              alt="banking binance"
            />
            <p className="mt-4 text-[24px] leading-[30px] text-center group-hover:text-left font-semibold text-[#0030C0]">
              Banking & Finance
            </p>
            <p className="mt-3 text-[16px] leading-[23px] text-[#0030C0] hidden group-hover:block">
        ...
        <div className="flex hover:block cursor-pointer group items-center justify-center h-[334px] border border-[#0083FF] rounded-[24px]">
          <div className="px-6">
            ...
            <p className="mt-3 text-[16px] leading-[23px] text-[#0030C0] hidden group-hover:block">
              ...
              Educational Analytics and Software for Corporate Trainings.
            </p>
          </div>
        </div>
        <div className="flex hover:block cursor-pointer group items-center justify-center h-[334px] border border-[#0083FF] rounded-[24px]">
          <div className="px-6">
            ...
            <p className="mt-3 text-[16px] leading-[23px] text-[#0030C0] hidden group-hover:block">
              ...
              Technology, Loytalty Programs, etc.
            </p>
          </div>
        </div>
        <div className="flex hover:block cursor-pointer group items-center justify-center h-[334px] border border-[#0083FF] rounded-[24px]">
        ...
        <div className="flex hover:block cursor-pointer group items-center justify-center h-[334px] border border-[#0083FF] rounded-[24px]">
          <div className="px-6">
            ...
            <p className="mt-3 text-[16px] leading-[23px] text-[#0030C0] hidden group-hover:block">
              ...
              projects across energy, transportation, automotive, retail,
              healthcare and more.
            </p>
          </div>
        </div>
