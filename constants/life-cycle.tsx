export const lifeCycleTop = [
  ...
  },
  {
    title: "Design",
    content:
      "Our web app design process begins with an analysis of the target audience and planning user-friendly journeys. Our UI designers then create a stylish interface, and our solution architects plan functional components and optimal tech to ensure a feasible business logic. We also map API connections within and outside the web solution.",
  },
];

export const lifeCycleBottom = [
  {
    title: "Implementation",
    content:
      "Our expert front-end developers can bring any design idea to life with seamless interface functionality using popular JavaScript frameworks. On the back end, our developers implement precise business logic with fast and quality coding in proven frameworks such as .Net, Java, Python, Node.js, PHP, and Go.",
  },
  {
